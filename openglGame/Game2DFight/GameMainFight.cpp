...
{
	auto colContr = CollisionController::getInstance();//初始化
	...
	target1->getComponent<ActorStateComponent>()->setName(L"木桩");
	...
	for (int i = 0; i < 20; i++)
	{
		...
		target2->getComponent<ActorStateComponent>()->setName(L"木桩");
